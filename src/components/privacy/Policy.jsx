          ...
          <div className="privacyContainer">
                ...
                <div id='ppBody'>
                    ...
                    <div className='ppConsistencies'>
                        ...
                        <div className='col-2'>
                            <div className="col-12 quick-links2 gen-text-center"> Fair Information Practices <div
                                className="col-8 gen-text-left gen-xs-text-center">Fair information<br/> Practices</div>
                            </div>
                        </div>
                        <div className='col-2'>
                    ...
                    <div></div>
                    <div className='innerText'>This privacy policy has been compiled to better serve those who are
                    ...
                    <div className='grayText'><strong>What personal information do we collect from the people that visit
                        our blog, website or app?</strong></div>
                    <br/>
                ...
                <br/>
                    ...
                    <br/>
                    <div className='innerText'>We collect information from you when you or enter information on our
                        site.
                    </div>
                    <br/> <span id='infoUs'></span><br/>
                        <div className='grayText'><strong>How do we use your information? </strong></div>
                        <br/>
                        <div className='innerText'> We may use the information we collect from you when you register,
                            make a purchase, sign up for our newsletter, respond to a survey or marketing communication,
                            surf the website, or use certain other site features in the following ways:<br/><br/></div>
                        <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> To improve our
                            website in order to better serve you.
                        </div>
                        <span id='coUs'></span><br/>
                        <div className='grayText'><strong>Do we use 'cookies'?</strong></div>
                        <br/>
                        <div className='innerText'>Yes. Cookies are small files that a site or its service provider
                        ...
                        <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> Compile
                        ...
                        <div className='innerText'><br/>You can choose to have your computer warn you each time a cookie
                            is being sent, or you can choose to turn off all cookies. You do this through your browser
                        ...
                        <br/>
                            <div className='innerText'>If you turn cookies off, Some of the features that make your site
                            ...
                            <br/><span id='trDi'></span><br/>
                                ...
                                <br/>
                                <div className='innerText'>We do not sell, trade, or otherwise transfer to outside
                                ...
                                <br/>
                                <div className='innerText'>We do not include or offer third-party products or services
                                    on our website.
                                </div>
                                ...
                                <div className='innerText'><br/>Google, as a third-party vendor, uses cookies to serve
                                    ads on our site. Google's use of the DART cookie enables it to serve ads to our
                                    users based on previous visits to our site and other sites on the Internet. Users
                                ...
                                <br/>
                                    ...
                                    <div className='innerText'><br/><strong>Opting out:</strong><br/>Users can set
                                        ...
                                        Opt Out page or by using the Google Analytics Opt Out Browser add on.</div>
                                    <span id='calOppa'></span><br/>
                                    <div className='blueText'><strong>California Online Privacy Protection Act</strong>
                                    </div>
                                    <br/>
                                    <div className='innerText'>CalOPPA is the first state law in the nation to require
                                    ...
                                    <div className='innerText'><br/><strong>According to CalOPPA, we agree to the
                                        following:</strong><br/></div>
                                    <div className='innerText'>Users can visit our site anonymously.</div>
                                    <div className='innerText'>Once this privacy policy is created, we will add a link
                                        to it on our home page or as a minimum, on the first significant page after
                                        entering our website.<br/></div>
                                    <div className='innerText'>Our Privacy Policy link includes the word 'Privacy' and
                                        can easily be found on the page specified above.
                                    </div>
                                    <div className='innerText'><br/>You will be notified of any Privacy Policy changes:
                                    </div>
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> On
                                        our Privacy Policy Page<br/></div>
                                    <div className='innerText'>Can change your personal information:</div>
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <strong>&bull;</strong> By
                                        emailing us
                                    </div>
                                    <div className='innerText'><br/><strong>How does our site handle Do Not Track
                                    ...
                                    <div className='innerText'><br/><strong>Does our site allow third-party behavioral
                                        tracking?</strong><br /></div>
                                    <div className='innerText'>It's also important to note that we do not allow
                                        third-party behavioral tracking
                                    </div>
                                    <span id='coppAct'></span><br/>
                                    <div className='blueText'><strong>COPPA (Children Online Privacy Protection
                                        Act)</strong></div>
                                    <br/>
                                    <div className='innerText'>When it comes to the collection of personal information
                                        ...
                                        privacy and safety online.<br/><br/></div>
                                    <div className='innerText'>We do not specifically market to children under the age
                                        of 13 years old.
                                    </div>
                                    ...
                                    <div className='innerText'><strong>In order to be in line with Fair Information
                                    ...
                                    <div className='innerText'><br/>We also agree to the Individual Redress Principle
                                    ...
                                    <div className='innerText'><strong>We collect your email address in order
                                        to:</strong></div>
                                    <div className='innerText'><br/><strong>To be in accordance with CANSPAM, we agree to
                                        the following:</strong></div>
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <strong>&bull;</strong> Not use false or misleading subjects or email addresses.
                                    </div>
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <strong>&bull;</strong> Identify the message as an advertisement in some
                                        reasonable way.
                                    </div>
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <strong>&bull;</strong> Include the physical address of our business or site
                                        headquarters.
                                    </div>
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <strong>&bull;</strong> Monitor third-party email marketing services for
                                    ...
                                    <div className='innerText'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <strong>&bull;</strong> Allow users to unsubscribe by using the link at the
                                        bottom of each email.
                                    </div>
                                    <div className='innerText'><strong><br/>If at any time you would like to unsubscribe
                                        from receiving future emails, you can email us at</strong></div>
                                    <div className='innerText'>info@ab-it.io and we will promptly remove you
                                        from <strong>ALL</strong> correspondence.
                                    </div>
                                    <br/><span id='ourCon'></span><br/>
                                        ...
                                        <div className='innerText'>Automation For business IT SRL</div>
                                        <div className='innerText'>ARH. Ionescu Grigore NR 63 BL I,73 SC B ET4 AP 42</div>
                                        Bucharest, Bucharest 023674 <div className='innerText'>Romania</div>
                                        <div className='innerText'>info@ab-it.io</div>
                                        <div className='innerText'><br/>Last Edited on 2018-02-28</div>
            </div>
